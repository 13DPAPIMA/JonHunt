    ...
    <div class="min-h-screen bg-center bg-gray-100 dark:bg-dots-lighter dark:bg-gray-900 selection:bg-red-500 selection:text-white overflow-hidden">
        <div v-if="canLogin" class="flex justify-end px-6">
            ...
            <template v-else>
                ...
                <Link
                    :href="route('login')"
                    class="mx-5 my-5 font-inter font-semibold text-gray-600 hover:text-gray-900 dark:text-gray-400 dark:hover:text-white focus:outline focus:outline-2 focus:rounded-sm focus:outline-red-500"
                >Sign in</Link>
        ...
        <div class="max-w-full mx-auto p-6 lg:p-8">
            ...
            <div class="center">
                <h1 class="max-md:hidden flex-end my-40 text-red-600 text-7xl font-semibold">You Found The Right Freelance Platform </h1>
            </div>
   
            <div class="flex justify-end bg-white-600 w-full h-screen max-md:hidden">
                <div class="w-1/2 bg-red-600 overflow-hidden">

                <img src="/freelancer_photo.jpg" alt="Freelancer Image" class="max-w-full w-700px h-screen ">
                </div>
            </div>
            ...
            <div class="content-center my-10">
                ...
                <h1 class="font-bold opacity-75">Trusted by: </h1>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 lg:gap-8">
            <div class="max-md:hidden flex w-full my-10 max-w-3xl mx-auto mt-400 scroll-smooth">
                <h1 class="my-5 text-red-600 text-4xl font-semibold">Popular Services</h1>
            </div>
        </div>
        <div class="flex flex-row content-center items-center justify-center max-md:flex-col">
            <div class="max-w-sm mx-2 mb-4 rounded overflow-hidden shadow-lg transform transition-transform duration-300 hover:scale-105">
                <div class=" px-6 py-4 bg-red-600 text-white">
                    ...
                    <p class="text-base">Over 100+ projects</p>
                </div>
            </div>
            <div class="max-w-sm mx-2 mb-4 rounded overflow-hidden shadow-lg transform transition-transform duration-300 hover:scale-105">
                <div class="px-6 py-4 bg-red-600 text-white">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 lg:gap-8">
                <div class="max-md:hidden flex w-full my-10 max-w-3xl mx-auto mt-400 scroll-smooth">
                    <h1 class="flex-end my-10 text-red-600 text-7xl font-semibold">Over 2000+ projects</h1>
                </div>
